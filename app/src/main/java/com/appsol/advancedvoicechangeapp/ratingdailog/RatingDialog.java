package com.appsol.advancedvoicechangeapp.ratingdailog;
...
public class RatingDialog extends AppCompatDialog implements  View.OnClickListener {
    ...
    private LottieAnimationView ratingBarAnimation, ratingBarSmiley;
    private ImageButton rateUS;
    private ImageButton crossButton;
    private TextView tvTitle, tvFeedback, tvSubmit, tvCancel, tvGetRating;
    //    private TextView tvTitle, tvNegative, tvPositive, tvFeedback, tvSubmit, tvCancel,tvGetRating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.voice_changer_dialog_rating);


        ratingBarSmiley = findViewById(R.id.animationView);
        tvTitle = findViewById(R.id.dialog_rating_title);
        tvGetRating = findViewById(R.id.dialog_rating_get);
        rateUS = findViewById(R.id.rateUs);
        crossButton = findViewById(R.id.btn_cancel);
...
//        tvPositive = findViewById(R.id.dialog_rating_button_positive);
        ...
        ratingBarAnimation = findViewById(R.id.animationViewRatingBar);
    ...
    private void init() {
        ...
        new CountDownTimer(3000, 1000) {
            ...
            public void onFinish() {
                ratingBarAnimation.setVisibility(View.GONE);
...
//    }
    ...
    private void openForm() {
        ...
        ratingBarAnimation.setVisibility(View.GONE);
        ratingBarSmiley.setVisibility(View.GONE);
//        ivIcon.setVisibility(View.GONE);
        tvTitle.setVisibility(View.GONE);
        ratingBar.setVisibility(View.GONE);
        tvGetRating.setVisibility(View.GONE);
...
//    }
    ...
    public static class Builder {
        ...
        private String title, playstoreUrl;
        ...
        private void initText() {
            title = context.getString(R.string.we_are_working);
